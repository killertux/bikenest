...
impl ContributionHistoryReader for SqlxContributionHistoryReader {
    async fn history(&self, user: UserId) -> Result<Vec<ContributionItem>, ContributionError> {
        ...
        // Locations created.
        let added = sqlx::query_as::<_, SrcRow>(
        ...
        let edited = sqlx::query_as::<_, SrcRow>(
            r#"
        ...
        let proposed = sqlx::query_as::<_, SrcRow>(
            r#"
        ...
        // Reviews.
        let reviewed = sqlx::query_as::<_, SrcRow>(
            r#"
        ...
        let verified = sqlx::query_as::<_, SrcRow>(
            r#"
        ...
        // Favorites.
        let favorited = sqlx::query_as::<_, SrcRow>(
            r#"
