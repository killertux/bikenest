...
pub fn mock_parkings() -> Vec<MockParking> {
    ...
    vec![
        ...
        MockParking {
            ...
            lat: -25.409_000, lon: -49.268_000,
            hours: (1..=6).map(|d| (d, (9, 0), (18, 0), false)).collect(),
            hours_unknown: false,
            security: vec![
                ("indoor", 1), ("cctv", 1), ("staffed", 1),
                ("controlled_access", 1), ("well_lit", 1),
            ],
            rating_avg: Some(4.6), rating_count: 12,
        ...
        MockParking {
            ...
            lat: -25.439_200, lon: -49.264_000,
            hours: vec![(1, (6, 0), (21, 0), false), (2, (6, 0), (21, 0), false), (3, (6, 0), (21, 0), false), (4, (6, 0), (21, 0), false), (5, (6, 0), (21, 0), false)],
            hours_unknown: false,
            security: vec![("restricted_access", 1), ("indoor", 1), ("dedicated_locking_point", 1)],
            rating_avg: Some(3.8), rating_count: 4,
        ...
        MockParking {
            ...
            parking_type: ParkingType::Rack,
            cost: Cost::Free,
            lat: -25.425_800, lon: -49.308_500,
            hours: (1..=7).map(|d| (d, (5, 0), (23, 0), false)).collect(),
            hours_unknown: false,
            security: vec![("well_lit", 1)],
            rating_avg: Some(4.0), rating_count: 9,
        ...
        MockParking {
            ...
            lat: -25.443_000, lon: -49.238_500,
            hours: (1..=7).map(|d| (d, (6, 0), (20, 0), false)).collect(),
            hours_unknown: false,
            security: vec![
                ("security_guard", 1), ("controlled_access", 1),
                ("cctv", 1), ("indoor", 1), ("dedicated_locking_point", 1),
            ],
            rating_avg: Some(4.9), rating_count: 21,
        ...
        MockParking {
            ...
            parking_type: ParkingType::Rack,
            cost: Cost::Free,
            lat: -25.435_800, lon: -49.266_200,
            hours: vec![(1, (4, 0), (16, 0), false), (2, (4, 0), (16, 0), false), (3, (4, 0), (16, 0), false), (4, (4, 0), (16, 0), false), (5, (4, 0), (16, 0), false), (6, (4, 0), (14, 0), false)],
            hours_unknown: false,
            security: vec![("cctv", 1), ("well_lit", 0)],
            rating_avg: Some(3.5), rating_count: 2,
        ...
        MockParking {
            ...
            parking_type: ParkingType::ParkingFacility,
            cost: Cost::Free,
            lat: -25.428_800, lon: -49.271_200,
            hours: vec![(1, (0, 0), (23, 59), true), (2, (0, 0), (23, 59), true), (3, (0, 0), (23, 59), true), (4, (0, 0), (23, 59), true), (5, (0, 0), (23, 59), true), (6, (0, 0), (23, 59), true), (7, (0, 0), (23, 59), true)],
            hours_unknown: false,
            security: vec![("cctv", 1), ("well_lit", 1)],
            rating_avg: Some(4.2), rating_count: 15,
        ...
        MockParking {
            ...
            lat: -25.378_800, lon: -49.286_200,
            hours: (1..=7).map(|d| (d, (6, 0), (21, 0), false)).collect(),
            hours_unknown: false,
            security: vec![("controlled_access", 1), ("cctv", 1), ("dedicated_locking_point", 1)],
            rating_avg: Some(4.4), rating_count: 6,
        ...
        MockParking {
            ...
            lat: -25.448_500, lon: -49.277_000,
            hours: vec![],
            hours_unknown: true,
            security: vec![("security_guard", 1), ("indoor", 1)],
            rating_avg: Some(3.9), rating_count: 3,
        ...
        MockParking {
            ...
            lat: -25.440_500, lon: -49.288_000,
            hours: (1..=6).map(|d| (d, (6, 0), (20, 0), false)).collect(),
            hours_unknown: false,
            security: vec![
                ("restricted_access", 1), ("indoor", 1), ("cctv", 1),
                ("dedicated_locking_point", 1), ("controlled_access", 1),
            ],
            rating_avg: Some(4.8), rating_count: 11,
        ...
        MockParking {
            ...
            parking_type: ParkingType::Rack,
            cost: Cost::Free,
            lat: -25.447_000, lon: -49.282_000,
            hours: (1..=7).map(|d| (d, (0, 0), (23, 59), true)).collect(),
            hours_unknown: false,
            security: vec![],
            rating_avg: Some(3.0), rating_count: 1,
        ...
        MockParking {
            ...
            lat: -25.432_000, lon: -49.273_500,
            hours: (1..=6).map(|d| (d, (7, 0), (19, 0), false)).collect(),
            hours_unknown: false,
            security: vec![("security_guard", 1), ("cctv", 1), ("indoor", 1), ("well_lit", 1)],
            rating_avg: Some(4.0), rating_count: 4,
        ...
        MockParking {
            ...
            parking_type: ParkingType::Rack,
            cost: Cost::Free,
            lat: -25.450_000, lon: -49.250_000,
            hours: (1..=6).map(|d| (d, (6, 0), (21, 0), false)).collect(),
            hours_unknown: false,
            security: vec![("well_lit", 1)],
            rating_avg: Some(3.7), rating_count: 2,
        ...
        MockParking {
            ...
            rating_avg: Some(4.7), rating_count: 10,
